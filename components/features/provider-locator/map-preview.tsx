...
export function MapPreview() {
  return (
    <div className="space-y-4">
      ...
      <div className="relative aspect-[4/3] bg-navy/5 dark:bg-white/5 rounded-lg overflow-hidden">
        ...
        <div className="absolute bottom-4 left-4 right-4 bg-white/90 dark:bg-navy/90 backdrop-blur-sm rounded-lg p-3">
